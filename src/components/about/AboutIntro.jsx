  ...
  return (
    <div className="py-8 bg-background mb-16">
      ...
      <p className="text-secondary leading-relaxed text-lg">
        ...
        dedicated to connecting people with their dream properties. Our mission
        is simple yet powerful — to simplify property buying, selling, and
        renting with trust, transparency, and technology. Founded by a
